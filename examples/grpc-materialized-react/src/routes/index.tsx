...
function Home() {
  ...
  return isBrowserReady ? (
    ...
    <main className="example-shell">
      <section className="panel" aria-label="materialized grpc client placeholder">
        <h1>Materialized gRPC React example</h1>
        <p>Live materialized gRPC data connects in the browser.</p>
      </section>
    </main>
  );
}
